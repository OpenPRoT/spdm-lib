...
fn main() {
    ...
    println!("Certificate Chain: {} bytes", STATIC_CERTIFICATE_CHAIN.len());
    ...
    if STATIC_CERTIFICATE_CHAIN.len() == expected_len {
        ...
        println!("✗ Certificate chain length mismatch: expected {}, got {}", 
                expected_len, STATIC_CERTIFICATE_CHAIN.len());
    }
